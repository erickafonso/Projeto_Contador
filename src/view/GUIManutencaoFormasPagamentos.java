 ...
 * @author cralves
 */
public class GUIManutencaoFormasPagamentos extends javax.swing.JInternalFrame {
     ...
     */
    public GUIManutencaoFormasPagamentos() {
        initComponents();
        preencherTabela();
    }
    ...
    private void preencherTabela(){
        try {
            ...
            FormasPagamentosServicos cs = ServicosFactory.getFormasPagamentosServicos();
            
            ArrayList<FormasPagamentosVO> categoria = new ArrayList<>();
            //Criando um ArrayList<ProdutoVO> vazio para receber o ArryaList com os dados
            
            //Recebendo o ArrayList cheio no Produto
            categoria = cs.buscarFormaPagamento();
            
            System.out.println(categoria);
            for ( int i = 0; i < categoria.size(); i++) {
                dtm.addRow(new String[] { 
                    String.valueOf(categoria.get(i).getIdFormaPagamento()),
            ...
            JOptionPane.showMessageDialog(
                    null,
                    "Erro! GUIManutencaoFormasPagamentos.preencherTabela" + e.getMessage()  );
        }//fim do catch
    ...
    private void filtrar(){
        try {
            if( jtfPesquisaPro.getText().isEmpty() ) {
                ...
                FormasPagamentosServicos fps = ServicosFactory.getFormasPagamentosServicos();
                String pesquisa = (String) jcbPesquisaPro.getSelectedItem();
                String query;
                if( pesquisa.equals("Código")){
                    query = "where idFormaPagamento =  " + jtfPesquisaPro.getText();
                }else {
                ...
                ArrayList<FormasPagamentosVO> formapagamento = new ArrayList<>();
                
                //Recebendo o ArrayList cheio no produto
               // categoria = cs.filtrar(query);
                formapagamento = fps.pesquisarFormaPagamento(query);
                
                for( int i = 0; i < formapagamento.size(); i++){
                    dtm.addRow(new String[] {
                        String.valueOf(formapagamento.get(i).getIdFormaPagamento()),
                        String.valueOf(formapagamento.get(i).getNome()),
            ...
            JOptionPane.showMessageDialog(
                    null,
                    "Erro ao filtrar produto! GUIManutencaoFormaPagamento.filtrar " + e.getMessage() );
        }
    ...
    private void deletarFormaPagamento(){
        try {
            ...
            if( linha == -1 ){
                ...
                //ProdutoServicos ps = ServicosFactory.getProdutoServicos();
                FormasPagamentosServicos cs = ServicosFactory.getFormasPagamentosServicos();
                String codFormaPagamento = (String) jtProduto.getValueAt(linha, 0);
                cs.deletarFormaPagamento(Integer.parseInt(codFormaPagamento));
                
                //Mensagem para o usuário
                              
                JOptionPane.showMessageDialog(
                        null,
                        "FormaPagamento excluída com sucesso!");
            }//fim do else
        } catch (Exception e) {
            JOptionPane.showMessageDialog(
                    null,
                    "Erro ao deletar categoria! GUIManutencaoFormaPagamento.deletar" + e.getMessage() );
        }
    ...
    public void confirmarAlteracao(){
        try {
            FormasPagamentosVO cVO = new FormasPagamentosVO();
            if(jtfNome.getText().isEmpty()  ) 
            {
                ...
                cVO.setIdFormaPagamento(Integer.parseInt(jtfCodigo.getText() ) );
                cVO.setNome(jtfNome.getText() );

                
                FormasPagamentosServicos cs = ServicosFactory.getFormasPagamentosServicos();
                cs.alterarFormaPagamento(cVO);
                
                JOptionPane.showMessageDialog(
                        null,
                        "FormaPagamento alterada com sucesso!");
            }//fim do if else
        } catch (Exception e) {
            JOptionPane.showMessageDialog(
                    null,
