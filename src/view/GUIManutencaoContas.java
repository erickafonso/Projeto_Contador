 ...
 * @author cralves
 */
public class GUIManutencaoContas extends javax.swing.JInternalFrame {

    DefaultTableModel dtm = new DefaultTableModel(
                new Object[][]{},
            new Object[]{"Código", "Nome", "Valor", "Descricao", "Data de pagamento","Data de vencimento", "Categoria", "Forma de pagamento"}
    );
    /**
     * Creates new form GUIManutencaoProdutos
     */
    public GUIManutencaoContas() {
        initComponents();
        preencherTabela();
    }
    ...
    private void initComponents() {
        ...
        jtfDataVencimento.setToolTipText("");
        jtfDataVencimento.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jtfDataVencimentoActionPerformed(evt);
            }
        });
        ...
        jLayeredPane1.setLayer(jtfDataVencimento, javax.swing.JLayeredPane.DEFAULT_LAYER);
                        ...
                        .addGroup(jLayeredPane1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jLayeredPane1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jLayeredPane1Layout.createSequentialGroup()
                                    ...
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                    .addComponent(jtfDataVencimento, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jLayeredPane1Layout.createSequentialGroup()
        ...
        jtProduto.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome", "Valor", "Descricao", "Data de Pagamento", "Data de Vencimento", "Categoria", "Forma de pagamento"
            }
        ));
    ...
    private void preencherTabela(){
        try {
            ...
            ContasServicos ps = ServicosFactory.getContasServicos();
          ...
          //  ResultSet rs2 = cDAO.listarPerfil();
            ...
            ArrayList<ContasVO> despesa = new ArrayList<>();
            
            //Recebendo o ArrayList cheio no Produto
            despesa = ps.buscarConta();
            categorias = cDAO.buscarCategoria();
            formaspagamentos = fpDAO.buscarFormaPagamento();
           // ContasDAO DDAO = new ContasDAO();
             //despesa = DDAO.buscarConta();
            ...
            for ( int i = 0; i < despesa.size(); i++) {
                ...
                String datacagada1 = Conversao.dataFormaterToDB(despesa.get(i).getDataPagamento());
                System.out.println(datacagada1);
                String datacagada2 = Conversao.dataFormaterToDB(despesa.get(i).getDataVencimento());
                dtm.addRow(new String[] { 
                    String.valueOf(despesa.get(i).getIdConta()),
            ...
            JOptionPane.showMessageDialog(
                    null,
                    "Erro! GUIManutencaoContas.preencherTabela" + e.getMessage()  );
        }//fim do catch
        ...
        try {
            if( jtfPesquisaPro.getText().isEmpty() ) {
                ...
                if( pesquisa.equals("Código")){
                    query = "where idConta =  " + jtfPesquisaPro.getText();
                ...
                //Recebendo o ArrayList cheio no produto
                despesa = ps.filtrarContas(query);
                ...
                for( int i = 0; i < despesa.size(); i++){
                    dtm.addRow(new String[] {
                        ...
                        String.valueOf(despesa.get(i).getDescricao()),
                        String.valueOf(despesa.get(i).getDataPagamento()),
                        String.valueOf(despesa.get(i).getDataVencimento()),
                        String.valueOf(despesa.get(i).getCategoria()),
                        String.valueOf(despesa.get(i).getFormaPagamento()),
                    });
                }//fecha o laço for
    ...
    private void deletarConta(){
        try {
            ...
            if( linha == -1 ){
                ...
                //ProdutoServicos ps = ServicosFactory.getProdutoServicos();
                ContasServicos ps = ServicosFactory.getContasServicos();
                String codConta = (String) jtProduto.getValueAt(linha, 0);
                ps.deletarConta(Integer.parseInt(codConta));
            ...
            JOptionPane.showMessageDialog(
                    null,
                    "Erro ao deletar despesa! GUIManutencaoConta.deletar" + e.getMessage() );
        }
    ...
    private void alterarConta(){
        ...
        if(linha != -1){
            ...
            jtfDataVencimento.setText((String) jtProduto.getValueAt(linha, 5));

            jcbCategoriaConta.setSelectedItem((String) jtProduto.getValueAt(linha, 6));
            jcbFormaPagamentoConta.setSelectedItem((String) jtProduto.getValueAt(linha, 7));
    ...
    public void confirmarAlteracao(){
        try {
                    ...
                    jtfDataPagamento.getText().isEmpty() ) 
            {
                ...
                dVO.setIdConta(Integer.parseInt(jtfCodigo.getText() ) );
            ...
            dVO.setDataPagamento(data);
             dataCrua =  jtfDataVencimento.getText();
            data = dataFormatada.parse(dataCrua);
            dVO.setDataVencimento(data);
    ...
    private void jtfDataVencimentoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtfDataVencimentoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jtfDataVencimentoActionPerformed
